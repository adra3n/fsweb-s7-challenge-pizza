...
const App = () => {
  ...
  return (
    <div className='main-Container' >
      <nav className='nav-Container' style={{ textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", width: "100vw", height: "15vh", margin: "0", backgroundColor: "#CE2829" }}><h1 >
