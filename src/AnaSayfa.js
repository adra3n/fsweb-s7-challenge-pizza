...
const AnaSayfa = () => {
    return (
        <div className='anasayfa-Container'>
            ...
            <Button id="order-pizza" size="lg" style={{ width: "10vw", padding: "2%", backgroundColor: "#FDC913", border: "0px", margin: " 2vh 0 5vh 0", display: "flex", justifyContent: "center", padding: "0 2vw 0 2vw" }}>
